...
const journey: RouteStop[] = [
  {
    ...
    description: 'Specializing in Web and App Development. Building a strong foundation in software engineering, algorithms, data structures, and modern frontend & backend architectures.',
  },
  {
    id: '02',
    year: '2023 - PRESENT',
    title: 'FULL STACK & MOBILE ENGINEER',
    organization: 'PRODUCTION PROJECTS & LABS',
    description: 'Mastering React, React Native, and Node.js ecosystems. Architected 10+ end-to-end web & mobile applications with focus on performance, scalability, and clean modular code.',
  },
  {
    id: '03',
    year: '2023 - PRESENT',
    title: 'CREATIVE FRONTEND & 3D DESIGNER',
    organization: 'IMMERSIVE WEB EXPERIENCES',
    description: 'Engineering visually engaging 3D web environments using Three.js, React Three Fiber, GSAP animations, and custom shaders for high-impact interactive storytelling.',
  },
  {
    id: '04',
    year: '2021 - 2023',
    title: 'INTERMEDIATE / COLLEGE STUDIES',
    organization: 'ACADEMIC FOUNDATION',
    description: 'Completed foundational coursework in Computer Science, Mathematics, and Analytical Problem Solving with academic distinction.',
  },
];
